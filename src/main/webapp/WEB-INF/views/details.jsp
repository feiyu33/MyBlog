...
<div class="container table_box" style="margin-top: 30px">
    ...
    <div style="text-align: right;font-size: 16px;padding-top: 10px">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <label style="font-size: 15px;text-align: left"><span class="glyphicon glyphicon-thumbs-up" style="color: gray" aria-hidden="true"></span>  推荐(<span id="thumbUp">${blogPO.blog.thumbUpNumber}</span>)</label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <form id="comment_id" action="${path}/show/comment" method="post">
            <fieldset>
                ...
                <div class="col-lg-offset-1" style="padding-top: 20px;padding-left: 60px;padding-bottom: 15px">
                    <button type="submit"  style="width: 200px;text-align: center" class="btn btn-info" id="commentButton">评论</button>
                </div>
            </fieldset>
        </form>
    </c:if>
